...
function GenerateQuadsBricks(atlas)
    local tbl = GenerateQuads(atlas, 32, 16)
    local ret =  table.slice(tbl, 1, 21)
    table.insert(ret, tbl[24]) -- adding the lock brick
    return ret;
end

function GenerateQuadsPowerUps(atlas) -- get all the powerups
